<div
    ...
    <div class="text-sm font-semibold flex">50 &nbsp
        <div class="font-black text-emerald-500">/&nbsp 100</div>
    </div>
</div>
<div
    class="row-span-2 row-start-2 bg-white shadow-sm rounded-2xl place-content-center text-left p-8 border border-gray-300">
    ...
    <div class="text-sm font-semibold flex">30 &nbsp
        <div class="font-black text-sky-500">/&nbsp 100</div>
    </div>
</div>
<div
    class="row-span-2 row-start-2 bg-white shadow-sm rounded-2xl place-content-center text-left p-8 border border-gray-300">
    ...
    <div class="text-sm font-semibold flex">20 &nbsp
        <div class="font-black text-indigo-500">/&nbsp 100</div>
    </div>
</div>
