    ...
    <div class="mx-32">
        ...
        <div class="flex items-center justify-between mt-12">
            <div class="flex gap-4 items-center">
                ...
                <button
                    class="flex-wrap justify-between mx-auto text-black bg-white border border-gray-300 w-96 rounded-lg px-4 py-2 inline-flex items-center"
                    type="button">
                    2021
            ...
            <form method="GET" action="" onsubmit="this.action='/dosenpa/prestasi-akademik/' + this.nim.value;"
                ...
                <input type="text" name="nim" placeholder="Ketik Nomor Induk Mahasiswa"
                    class="flex-wrap justify-between mx-auto mr-4 text-black bg-white border border-gray-300 w-full rounded-lg px-4 py-2 inline-flex items-center">
            ...
            <div class="overflow-x-auto sm:rounded-2xl">
                <table class="w-full text-sm text-left bg-teal-900 border-collapse">
                    <thead class="font-black text-gray-200 border-b border-t border-gray-400">
                        @if (session('error'))
                            <div id="error-alert" class="py-6 px-8 bg-red-100 text-red-800 rounded flex justify-between items-center">
                                {{ session('error') }}
