...
@section('content')
    ...
    <div class="mx-20">
        ...
        <div class="flex justify-between mb-6 items-center">
            ...
            <div>
                <a href="#" class="text-center transition ease-in-out duration-150 hover:bg-teal-800 text-white bg-teal-700 rounded-full px-5 py-2.5 mr-2">
                    Cetak Laporan
                </a>
                <a href="#" class="text-center transition ease-in-out duration-150 hover:bg-teal-800 text-white bg-teal-700 rounded-full px-5 py-2.5">
                    Unduh Laporan
                </a>
            </div>
        </div>
