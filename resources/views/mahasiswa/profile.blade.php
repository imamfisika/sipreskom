            ...
            <div class="mx-32 mt-12 py-12 px-16 border rounded-2xl">
                ...
                <div class="grid gap-10 text-md">
                    <div class="flex gap-8 col-span-2">
                        ...
                        <div class="w-1/2">
                            <div class="text-gray-600 mb-2 text-sm font-bold">NIM :</div>
                    ...
                    <div class="flex gap-8 col-span-2">
                        <div class="w-1/2">
                            <div class="text-gray-600 mb-2 text-sm font-bold">Angkatan :</div>
                    ...
                    <div class="flex gap-8 col-span-2">
                        <div class="w-1/2">
                            <div class="text-gray-600 mb-2 text-sm font-bold">IPK :</div>
                            <input type="text" value=" {{ $ipksks['ipk'] ?? '-' }}" disabled
                                class="bg-gray-50 border border-gray-300 text-gray-500 rounded-lg block w-full p-2.5">
                        </div>
                        <div class="w-1/2">
                            <div class="text-gray-600 mb-2 text-sm font-bold">Total SKS :</div>
